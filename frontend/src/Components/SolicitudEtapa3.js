...
export const SolicitudEtapa3 = ({ solicitudData }) => {
  ...
  return (
    <div>
      ...
      <div>
        <strong>Monto Estimado de la Compra:</strong> {solicitudData.codigoCosto}
      </div>
      <div>
        {/* ... otros elementos ... */}
        <Link to="/solicitud-etapa4" >Confirmar Nueva Solicitud</Link>
        </div>
    </div>
  );
};