...
export const AccionesProductosAlmacenamiento = ({item, setModal,handleShow, handleEdit, handleDelete}) => {
  return (
    <div>
      <div className='btn-group btn-group-sm'>
        <button className='btn btn-primary' onClick={() => handleShow(item.IdProducto)}><i className="fa-solid fa-eye"></i></button>
        <button className='btn btn-warning'onClick={() => handleEdit(item.IdProducto)}><i className="fa-solid fa-pen"></i></button>
...
export default AccionesProductosAlmacenamiento;
