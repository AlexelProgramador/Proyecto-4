...
export const FormCreateSolicitudBotiquin = ({botiquinData, selectedItems= [], handleBotiquinChange, solicitudData, setSolicitudData}) => {
    ...
    <div>
      ...
      <div className='col-md-4 pb-4'>
        <div className='form-floating'>
          ...
          <label htmlFor="BotiquinSolicitud">Botiquin a Seleccionar:</label>
        </div>
      </div>
      <div className='col-md-4 pb-4'>
        <div className='form-floating'>
...
export default FormCreateSolicitudBotiquin;