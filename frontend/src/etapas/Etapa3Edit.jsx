...
export const Etapa3Edit = () => {
        ...
        procesosEtapa3: formularios.map((formulario, index) => {
          ...
          return {
            ...
            factura: formulario.facturas.map((factura) => ({
              ...
              fechaemisionfact: factura.fechaemisionfact,
            ...
            urlArchivos: urlArchivos, // Usar la URL combinada de archivos antiguos y nuevos
          };
        }),
      };
  ...
  useEffect(() => {
    // Verificar si se ha recuperado la información de la solicitud
    if (infoSolicitud) {
      // Actualizar el estado de los formularios
      setFormularios(item.procesosEtapa3.map((formulario, index) => ({
        ncdp: formulario.ncdp || "",
        estado: formulario.estado || "",
        proveedor: formulario.proveedor || "",
        facturas: formulario.factura.map(factura => ({
          nrofactura: factura.nrofactura || "",
          fechaemisionfact: factura.fechaemisionfact || "",
          fechamaxima: factura.fechamaxima || "",
          aceptadassi: factura.aceptadassi || "",
        ...
        archivos: item.procesosEtapa3[index].urlArchivos || [], // Inicializar archivos antiguos
      })));
    }
  }, [infoSolicitud]);

  // console.log("formularios archvios", infoSolicitud)
  // Factura
            ...
            <div className="card shadow-card rounded-3 border border-0 mb-5">
              <div className="card-body ">
                  ...
                  <div key={procIndex}>
                    ...
                    {formularios[procIndex] && (
                      <form className="row px-2" onSubmit={(e) => handleSubmit(e, procIndex)}>
                        ...
                        <div className="col-md-5 form-floating mt-2 mb-2 g-2">
                          <input
                            type="text"
                            className="form-control"
                        ...
                        {formularios[procIndex].facturas.map((factura, numIndex) => (
                          ...
                          <div className="col-md-4 form-floating mt-2 g-2">
                            <input
                              type="date"
                              className="form-control"
                              id={`fechaemisionfact${procIndex}`}
                              value={factura.fechaemisionfact}
                              onChange={(e) => 
                                updateFactura(procIndex, numIndex, 'fechaemisionfact', e.target.value)}
                            />
                          ...
                          <div className="col-md-4 form-floating mt-2 g-2">
                            <input
                              ...
                              <div className="col-md-8 form-floating mt-2 mb-2 g-2">
                                <input
                                  type="text"
                                  className="form-control"
                ...
                <button
                  ...
                  type="button"
                  onClick={() => navigate("/verSolicitud", {state: { item }})}
                >
                  Atrás
                </button>
              </div>
